...
ssh cloud-user@sascas01 sudo /etc/init.d/sas-viya-cascontroller-default restart
ssh cloud-user@sascas02 sudo /etc/init.d/sas-viya-cascontroller-default restart
ssh cloud-user@sascas03 sudo /etc/init.d/sas-viya-cascontroller-default restart
