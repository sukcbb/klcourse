...
ssh cloud-user@sascas01 sudo /etc/init.d/sas-viya-cascontroller-defaults stop
ssh cloud-user@sascas01 sudo /etc/init.d/sas-viya-cascontroller-defaults start
